# Unpaired Semantic Segmentation and Image Synthesis with SPADE
TODO
<div align="center">
...
Use `--eval` to also compute FID score, mIoU and accuracy over the generated images. If you want to testo only over a subset of the dataset, use `--how_many` to specify the maximum number of images to generate. 
