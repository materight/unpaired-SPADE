...
if opt.evaluate:
    ...
    process = subprocess.run(['python', '-m', 'pytorch_fid', original_dataroot, generated_dataroot, '--num-workers', str(os.cpu_count()), '--device', str(device), '--batch-size', '1'], stdout=subprocess.PIPE)
